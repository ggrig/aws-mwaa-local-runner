...
import boto3
ags_west = boto3.client('autoscaling', region_name='us-west-2')
...
with DAG(
    ...
    # from tests_system_utils.watcher import watcher
...
from tests_system_utils import get_test_run  # noqa: E402
